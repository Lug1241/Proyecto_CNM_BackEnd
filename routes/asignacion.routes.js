...
const {Docente,DocenteANDReprsentante,docenteVicerrector,DocenteVicerrectorANDSecretaria,docenteAdministrador,docenteAdministradorOVicerrector}=require('../middlewares/protect')
module.exports = (app) => {
    app.post('/api/asignacion/crear',Docente, AsignacionController.createAsignacion);
    app.put('/api/asignacion/editar/:id',docenteAdministradorOVicerrector ,AsignacionController.updateAsignacion);
